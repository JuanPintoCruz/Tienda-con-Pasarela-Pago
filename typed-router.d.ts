...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'dashboards-categoria': RouteRecordInfo<'dashboards-categoria', '/dashboards/categoria', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-inicio': RouteRecordInfo<'dashboards-inicio', '/dashboards/inicio', Record<never, never>, Record<never, never>>,
    'dashboards-orders': RouteRecordInfo<'dashboards-orders', '/dashboards/orders', Record<never, never>, Record<never, never>>,
    'dashboards-producto': RouteRecordInfo<'dashboards-producto', '/dashboards/producto', Record<never, never>, Record<never, never>>,
